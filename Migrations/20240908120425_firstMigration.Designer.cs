...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ABP_RoomBookingApp.Model.HallConference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ABP_RoomBookingApp.Model.PriceModifiers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ABP_RoomBookingApp.Model.ServiceConference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HallConferenceServiceConference", b =>
                {
                    b.HasOne("ABP_RoomBookingApp.Model.HallConference", null)
                        .WithMany()
                        .HasForeignKey("ConferencesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ABP_RoomBookingApp.Model.ServiceConference", null)
                        .WithMany()
